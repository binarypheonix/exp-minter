            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.trys.push([1, 3, , 4]);
                            return [4 /*yield*/, this.context.metadataProvider.provideMetadata(this.contractAbstraction, tzip16.bytes2Char(uri), this.context)];
                        case 2:
                            metadataFromUri = _a.sent();
            ...
            try {
                for (var _e = __values(metadataTokenMap.keys()), _f = _e.next(); !_f.done; _f = _e.next()) {
                    ...
                    if (keyTokenMetadata === 'decimals') {
                        Object.assign(tokenMetadataDecoded, (_b = {}, _b[keyTokenMetadata] = Number(tzip16.bytes2Char(metadataTokenMap.get(keyTokenMetadata))), _b));
                    }
                    else if (!(keyTokenMetadata === '')) {
                        Object.assign(tokenMetadataDecoded, (_c = {}, _c[keyTokenMetadata] = tzip16.bytes2Char(metadataTokenMap.get(keyTokenMetadata)), _c));
                    }
                }
            }
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.trys.push([1, 3, , 4]);
                            return [4 /*yield*/, this.context.contract.getBigMapKeyByID(bigmapTokenMetadataId['int'].toString(), tokenId.toString(), new michelsonEncoder.Schema(tokenMetadataBigMapType))];
                        case 2:
                            pairNatMap = _a.sent();
                            return [3 /*break*/, 4];
                        case 3:
