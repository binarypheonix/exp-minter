...
<head>
    <title>Code coverage report for src/tzip16-contract-abstraction.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> tzip16-contract-abstraction.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { BigMapAbstraction, Context, ContractAbstraction, ContractProvider, Wallet } from '@taquito/taquito';
...
&nbsp;
     ...
     */
    async getMetadata() {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!this._metadataProvider) {
<span class="cstat-no" title="statement not covered" >            throw new UnconfiguredMetadataProviderError();</span>
        }
...
&nbsp;
    async metadataViews() {
        if (<span class="missing-if-branch" title="if path not taken" >I</span>Object.keys(this._metadataViewsObject).length === 0) {
...
&nbsp;
    private createViewImplementations(view: ViewDefinition, metadataViews: any) {
        for (let viewImplementation of view<span class="branch-0 cbranch-no" title="branch not covered" >?.i</span>mplementations ?? []) {
            if (view.name) {
