...
<head>
    <title>Code coverage report for src/taquito-tzip16.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> taquito-tzip16.ts</h1>
        <div class='clearfix'>
...
&nbsp;
export { bytes2Char, <span class="fstat-no" title="function not covered" >char2Bytes </span>} from "@taquito/utils";</pre></td></tr></table></pre>
