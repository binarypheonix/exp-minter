...
<head>
    <title>Code coverage report for src/viewKind/michelson-storage-view.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/viewKind</a> michelson-storage-view.ts</h1>
        <div class='clearfix'>
...
<a name='L182'></a><a href='#L182'>182</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">2x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { ParameterSchema } from '@taquito/michelson-encoder';
    ...
    private illegalUseOfSelfInstruction(code: MichelsonV1ExpressionExtended[]) {
        for (let instruction of code) {
            if (instruction.prim === 'SELF') {
                ...
                const nextInstruction = code[index + 1] ? code[index + 1].prim : <span class="branch-1 cbranch-no" title="branch not covered" >undefined;</span>
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!sigs.find((x: any[]) =&gt; x.length === args.length)) {
<span class="cstat-no" title="statement not covered" >            throw new InvalidViewParameterError(viewName, sigs, args);</span>
        }
    };
&nbsp;
...
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (viewParameterType.prim === 'unit') {
            if (args.length === 0) {
                args = ['Unit'];
            }
...
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if(!this.viewParameterType) {
...
&nbsp;
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if(protocolHash === Protocols.PtEdo2Zk) {
<span class="cstat-no" title="statement not covered" >            Object.assign(viewScript, { balance: '0' });</span>
        }
&nbsp;
