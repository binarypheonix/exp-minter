...
<head>
    <title>Code coverage report for src/viewKind/viewFactory.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/viewKind</a> viewFactory.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { RpcClient } from '@taquito/rpc';
    ...
    getView(
        ...
        if (this.isMichelsonStorageView(viewImplementation)) {
            ...
            return <span class="fstat-no" title="function not covered" >() =&gt; {</span>
                const view = <span class="cstat-no" title="statement not covered" >new MichelsonStorageView(</span>
                    viewName,
                    contract,
                    rpc,
