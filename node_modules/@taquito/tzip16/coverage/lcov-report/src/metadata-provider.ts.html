...
<head>
    <title>Code coverage report for src/metadata-provider.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> metadata-provider.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { ContractAbstraction, ContractProvider, Wallet, Context } from '@taquito/taquito';
...
<span class="cstat-no" title="statement not covered" >            throw new ProtocolNotSupported(uriInfo.protocol);</span>
        }
&nbsp;
...
&nbsp;
        return {
            ...
            integrityCheckResult: uriInfo.sha256hash ? <span class="branch-0 cbranch-no" title="branch not covered" >uriInfo.sha256hash === sha256Hash </span>: undefined,
            sha256Hash: uriInfo.sha256hash ? <span class="branch-0 cbranch-no" title="branch not covered" >sha256Hash </span>: undefined
        }
    }
&nbsp;
