...
declare type Methods = {
    ...
    configure: (opening_price: nat, set_reserve_price: nat, set_start_time: timestamp, set_round_time: int, ticket: ticket) => Promise<void>;
    drop_price: (param: nat) => Promise<void>;
    start: () => Promise<void>;
};
export declare type TicketAuctionContractType = {
    methods: Methods;
    storage: Storage;
    code: {
